...
class Scene:
    ...
    def load(self):
        ...
        add(WolfClaws(app, pos=(-10, -4, -17), scale=(10, 10, 10), rot=(0,-140, 0)))
        add(WolfEyes(app, pos=(-10, -4, -17), scale=(10, 10, 10), rot=(0,-140, 0)))
        add(WolfTeeth(app, pos=(-10, -4, -17), scale=(10, 10, 10), rot=(0,-140, 0)))
        add(WolfFur(app, pos=(-10, -4, -17), scale=(10, 10, 10), rot=(0,-140, 0)))
        ##################################################################################
        ...
        add(WolfTeeth(app, pos=(20, -4, -40), scale=(15, 15, 15), rot=(0,165, 0)))
        ...
        add(WolfTeeth(app, pos=(-40, -4, 23), scale=(6, 6, 6), rot=(0,-45, 0)))
        ##################################################################################
        ...
        add(WolfTeeth(app, pos=(-30, -4, 30), scale=(6, 6, 6), rot=(0,-45, 0)))
        ##################################################################################
        ...
        add(WolfTeeth(app, pos=(-40, -4, 33), scale=(10,10,10), rot=(0,-50, 0)))
        add(WolfFur(app, pos=(-40, -4, 33), scale=(10,10,10), rot=(0,-50, 0)))
        #! Trees
        add(Tree1(app, pos=(0, -4, -10), scale=(7, 7, 7)))
        add(Tree1(app, pos=(10, -4, -10), scale=(5, 5, 5)))
        add(Tree1(app, pos=(17, -4, 36), scale=(5, 5, 5)))
        add(Tree1(app, pos=(6, -4, 6), scale=(7, 7, 7)))
        add(Tree1(app, pos=(26, -4, 20), scale=(5, 5, 5)))
        add(Tree1(app, pos=(40, -4, 20), scale=(7, 7, 7)))
        add(Tree1(app, pos=(35, -4, 25), scale=(5, 5, 5)))
        add(Tree1(app, pos=(-20, -4, 20), scale=(5, 5, 5)))
        add(Tree1(app, pos=(-10, -4, -10), scale=(5, 5, 5)))
        add(Tree1(app, pos=(-5, -4, 30), scale=(5, 5, 5)))
        add(Tree1(app, pos=(-13, -4, -22), scale=(5, 5, 5)))
        add(Tree1(app, pos=(-20, -4, 0), scale=(7, 7, 7)))
